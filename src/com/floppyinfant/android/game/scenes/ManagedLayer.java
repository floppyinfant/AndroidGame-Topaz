...
public abstract class ManagedLayer extends HUD {
	 ...
	 * Creates a layer that does not unload when hidden.
	 */
	public ManagedLayer() {
		this(false);
	}
	...
	/**
	 * Constructor. 
	 * Sets whether the layer will unload when hidden 
	 * and ensures that there is no background on the layer.
	 * 
	 * @param pUnloadOnHidden
	 */
	...
	/**
	 * If the layer is not loaded, load it. 
	 * Ensure that the layer is not paused.
	 */
