...
public abstract class AbstractGameScene extends ManagedScene implements IOnSceneTouchListener, IPinchZoomDetectorListener {
	...
	private float mInitialPinchZoomFactor;
	private static final float MIN_ZOOM_FACTOR = 0.125f;
...
//		mCamera.setHUD(mHUD);
	...
	public void onLoadScene() {
		...
		/* Background */
		Sprite background = new Sprite(res.cameraWidth / 2f, res.cameraHeight / 2f, res.backgroundMarTextureRegion, res.engine.getVertexBufferObjectManager());
		// TODO Scaling
