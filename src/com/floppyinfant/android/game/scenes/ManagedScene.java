...
public abstract class ManagedScene extends Scene {
	...
	/**
	 * Tells the Scene Manager that the managed scene either has or doesn't have 
	 * a loading screen.
	 */
	public final boolean hasLoadingScreen;
	
	/**
	 * The minimum length of time (in seconds) 
	 * that the loading screen should be displayed.
	 */
	public final float minLoadingScreenTime;
	
	/**
	 * Keeps track of how long the loading screen has been visible. 
	 * Set by the SceneManager.
	 */
	...
	/**
	 * Constructor 
	 * that sets the minimum length of the loading screen 
	 * and sets hasLoadingScreen accordingly.
	 * 
	 ...
	 * It calls onLoadScene if loading is needed, 
	 * sets the isLoaded status, 
	 * and pauses the scene while it's not shown.
	 */
	...
	/**
	 * Called by the Scene Manager. 
	 * It calls onUnloadScene if the scene has been previously loaded 
	...
	/**
	 * Called by the Scene Manager. 
	 * It unpauses the scene before showing it.
	 */
	...
	/**
	 * Called by the Scene Manager. 
	 * It pauses the scene before hiding it.
	 */
